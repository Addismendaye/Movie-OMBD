...
function validateForm() {
  ...
  let minYear = 1928;
  let qparams = '';
  let searchKey = document.forms['formSearchMovie']['searchKey'].value;
  ...
  let searchYear = document.forms['formSearchMovie']['searchYear'].value;
  ...
  let plot = document.querySelector('input[name="plot"]:checked');
  if (plot != null) {
    qparams = qparams + '&plot=' + plot.defaultValue;
  } else {
    errorFound = true;
    document.getElementById('plotErr').innerHTML =
      'Please short plot or long plot';
  }
